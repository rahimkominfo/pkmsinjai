...
<div class="max-w-container_max_width mx-auto">
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="<?= base_url('admin/' . tenant()->pkm_slug . '/menu/create') ?>" class="bg-primary text-on-primary px-4 py-2 rounded font-data-table text-data-table hover:shadow-sm hover:-translate-y-[1px] transition-all flex items-center gap-2 self-start md:self-auto">
    ...
    <div class="bg-surface-container-lowest border border-surface-variant rounded-lg p-[24px] level-1-surface overflow-x-auto">
        <table class="w-full text-left border-collapse min-w-[600px]">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="p-4 text-center font-body-md text-outline-variant">Belum ada data menu.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
