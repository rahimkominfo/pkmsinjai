                ...
                <?php if (!empty($users)): ?>
                    ...
                    <tr class="border-b border-surface-container-low hover:bg-[#eff4ff] transition-colors">
                        ...
                        <td class="p-3 text-right">
                            <a href="<?= base_url('admin/' . tenant()->pkm_slug . '/pengguna/edit/' . $user['user_uuid']) ?>" class="text-primary hover:text-primary-container transition-colors p-1" title="Edit">
                                <span class="material-symbols-outlined text-[20px]">edit</span>
                            </a>
                            <a href="<?= base_url('admin/' . tenant()->pkm_slug . '/pengguna/delete/' . $user['user_uuid']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?')" class="text-error hover:text-error-container transition-colors p-1 ml-2" title="Hapus">
