        ...
        <div class="absolute inset-0 flex flex-col justify-end pb-16 md:pb-24">
            <div class="max-w-container-max mx-auto px-margin-mobile md:px-gutter w-full">
                <div class="max-w-3xl">
                    ...
                    <a href="<?= base_url(tenant()->pkm_slug . '/berita/detail/' . esc($hero_artikel[0]['slug'])) ?>" class="inline-block bg-white text-primary px-6 py-3 rounded-lg font-label-md text-label-md hover:bg-surface-container transition-colors shadow-md">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
